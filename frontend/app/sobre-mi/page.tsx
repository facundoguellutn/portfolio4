          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="space-y-4">
                <h2 className="text-3xl sm:text-5xl font-bold text-slate-800">Curioso</h2>
                <h2 className="text-3xl sm:text-5xl font-bold text-slate-800">Activo</h2>
        ...
        <div className="container mx-auto px-4 flex flex-col items-center justify-center">
          <div className="space-y-24">
            ...
            <motion.div 
              ...
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
              className="flex flex-col md:flex-row gap-6 lg:gap-12 items-center justify-around w-full "
            >
            ...
            <motion.div 
              ...
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
              className="flex flex-col md:flex-row gap-6 lg:gap-20 items-center justify-around w-full "
            >
              <motion.div 
                initial={{ opacity: 0, scale: 0.8 }}
                whileInView={{ opacity: 1, scale: 1 }}
